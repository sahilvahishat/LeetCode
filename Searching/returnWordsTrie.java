...
public class returnWordsTrie {
    ...
    private Node trie; // The trie

    public void Autocomplete(String[] dict) { // Construct the trie from the dictionary
        trie = new Node("");
        for (String s : dict)
            insertWord(s);
    }
    ...
    private void insertWord(String s) {
        // Iterate through each character in the string. If the character is not already
        // in the trie then add it
        Node curr = trie;
